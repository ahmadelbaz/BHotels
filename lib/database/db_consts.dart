...
List<RoomType> defaultRoomTypes = [
  ...
  RoomType(id: 1, name: 'Twin or Double Room'),
  RoomType(id: 2, name: 'Studio Room'),
  RoomType(id: 3, name: 'Deluxe Room'),
  RoomType(id: 4, name: 'Suite'),
  RoomType(id: 5, name: 'Presidential Suite'),
];
